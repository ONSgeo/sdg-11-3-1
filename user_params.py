...
class UserParams:
    def __init__(self) -> None:
        ...
        self.pop_t1_kwargs = {"sheet_name": "Mid-2013 Persons", "skiprows": 4, "index_col": "Area Codes", "thousands": ","}
        ...
        # any keyword arguments needed for reading the file
        # if none set as empty dict: {}
        self.pop_t2_kwargs = {"sheet_name": "Mid-2016 Persons", "skiprows": 4, "index_col": "Area Codes", "thousands": ","}
        ...
        # any keyword arguments needed for reading the file
        # if none set as empty dict: {}
        self.pop_t3_kwargs = {"sheet_name": "Mid-2019 Persons", "skiprows": 4, "engine": "openpyxl", "index_col": "LSOA Code", "thousands": ","}
        ...
        self.land_t1_file_path: str = f'{self.root_dir}/sdg_11_3_1_data/2019_2016_2013/lsoa2016_2013_landcover_area_GB.csv'

        # any keyword arguments needed for reading the file
        # if none set as empty dict: {}
        self.land_t1_kwargs: Dict[str, Union[str, int]] = {"index_col": "LSOA11CD", "thousands": ","}
        ...
        self.land_t2_file_path: str = f'{self.root_dir}/sdg_11_3_1_data/2019_2016_2013/lsoa2016_2013_landcover_area_GB.csv'

        # any keyword arguments needed for reading the file
        # if none set as empty dict: {}
        self.land_t2_kwargs: Dict[str, Union[str, int]] = {"index_col": "LSOA11CD", "thousands": ","}
        ...
        self.land_t3_file_path: str = f'{self.root_dir}/sdg_11_3_1_data/2019_2016_2013/lsoa2019_landcover_area_GB - Copy.csv'

        # any keyword arguments needed for reading the file
        # if none set as empty dict: {}       
        self.land_t3_kwargs: Dict[str, Union[str, int]] = {"index_col": "LSOA11CD", "thousands": ","}
    ...
    def set_input_files(self) -> None:
        self.input_files: Dict[str, InputFile] = {
            "pop_t1": InputFile(self.pop_t1_file_path, kwargs=self.pop_t1_kwargs, year=self.pop_t1_year, pop_col_init=self.pop_t1_age_col),
            "pop_t2": InputFile(self.pop_t2_file_path, kwargs=self.pop_t2_kwargs, year=self.pop_t2_year, pop_col_init=self.pop_t2_age_col),
            "pop_t3": InputFile(self.pop_t3_file_path, kwargs=self.pop_t3_kwargs, year=self.pop_t3_year, pop_col_init=self.pop_t3_age_col),
            "land_t1": InputFile(self.land_t1_file_path, kwargs=self.land_t1_kwargs, land_col = self.land_t1_land_col, filter_land_flag = self.land_t1_filter_land_flag, filter_land_col=self.land_t1_filter_land_col, filter_land_value=self.land_t1_filter_land_value),
            "land_t2": InputFile(self.land_t2_file_path, kwargs=self.land_t2_kwargs, land_col = self.land_t2_land_col, filter_land_flag = self.land_t2_filter_land_flag, filter_land_col=self.land_t2_filter_land_col, filter_land_value=self.land_t2_filter_land_value),
            "land_t3": InputFile(self.land_t3_file_path, kwargs=self.land_t3_kwargs, land_col = self.land_t3_land_col, filter_land_flag = self.land_t3_filter_land_flag, filter_land_col=self.land_t3_filter_land_col, filter_land_value=self.land_t3_filter_land_value)
        }